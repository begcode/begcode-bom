...
package com.begcode.report.core.export.excel.low;
...
public class CellStyleContext {
	...
	private BorderStyle getBorderStyle(Border border){
		if(border.getStyle().equals(com.begcode.report.core.definition.BorderStyle.solid)){
			return BorderStyle.THIN;
		}else if(border.getStyle().equals(com.begcode.report.core.definition.BorderStyle.dashed)){
			return BorderStyle.DASHED;
		}else if(border.getStyle().equals(com.begcode.report.core.definition.BorderStyle.doublesolid)){
