 ...
 * the License.
 ******************************************************************************/
package com.begcode.ureport.console.importexcel;

import com.begcode.ureport.core.definition.CellStyle;
import com.begcode.ureport.core.definition.PaperSize;
...
public class HSSFExcelParser extends ExcelParser {
    ...
    private CellStyle buildCellStyle(HSSFCell cell, HSSFWorkbook book) {
        ...
        if (!borderStyle.equals(BorderStyle.NONE)) {
            ...
            border.setStyle(com.begcode.ureport.core.definition.BorderStyle.solid);
            border.setWidth(1);
