...
import com.begcode.ureport.core.definition.Orientation;
import com.begcode.ureport.core.definition.Paper;
import com.begcode.ureport.core.definition.PaperType;
                ...
                for (Page page : pages) {
                    ...
                    for (Row r : rows) {
                        ...
                        for (int i = 0; i < columnSize; i++) {
                            ...
                            com.begcode.ureport.core.model.Cell cellInfo = colCell.get(col);
                            if (cellInfo == null) {
                                continue;
                            }
