 ...
 * the License.
 ******************************************************************************/
package com.begcode.ureport.core.export.excel.high.builder;

import com.begcode.ureport.core.Utils;
import com.begcode.ureport.core.build.paging.Page;
import com.begcode.ureport.core.chart.ChartData;
import com.begcode.ureport.core.definition.Paper;
import com.begcode.ureport.core.exception.ReportComputeException;
import com.begcode.ureport.core.export.excel.high.CellStyleContext;
import com.begcode.ureport.core.model.Column;
import com.begcode.ureport.core.model.Image;
import com.begcode.ureport.core.model.Report;
import com.begcode.ureport.core.model.Row;
import com.begcode.ureport.core.utils.ImageUtils;
...
public class ExcelBuilderWithPaging extends ExcelBuilder {
    public void build(Report report, OutputStream outputStream, boolean withSheet) {
        ...
        try {
            ...
            Map<Row, Map<Column, com.begcode.ureport.core.model.Cell>> cellMap = report.getRowColCellMap();
            ...
            for (Page page : pages) {
                ...
                for (int rowIndex = 0; rowIndex < rows.size(); rowIndex++) {
                    ...
                    Map<Column, com.begcode.ureport.core.model.Cell> colCell = cellMap.get(r);
                    int skipCol = 0;
                    for (int i = 0; i < columnSize; i++) {
                        ...
                        com.begcode.ureport.core.model.Cell cellInfo = null;
                        if (colCell != null) {
